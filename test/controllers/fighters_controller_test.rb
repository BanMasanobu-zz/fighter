...
class FightersControllerTest < ActionController::TestCase
  ...
  test "should create fighter" do
    assert_difference('Fighter.count') do
      post :create, fighter: { age: @fighter.age, from: @fighter.from, gym: @fighter.gym, height: @fighter.height, name: @fighter.name, nickname: @fighter.nickname, type: @fighter.type, weight: @fighter.weight }
    end
  ...
  test "should update fighter" do
    patch :update, id: @fighter, fighter: { age: @fighter.age, from: @fighter.from, gym: @fighter.gym, height: @fighter.height, name: @fighter.name, nickname: @fighter.nickname, type: @fighter.type, weight: @fighter.weight }
    assert_redirected_to fighter_path(assigns(:fighter))
  end
